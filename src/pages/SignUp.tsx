  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      notificationService.addNotification(
        "Welcome to eCourts Tracker",
        "Thank you for signing up. You can now track your court cases."
      );
        ...
        >
          ...
          >
            <div className="text-center mb-8">
              ...
              >
                Join eCourts Tracker to manage your cases
              </motion.p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center">
                ...
                <label htmlFor="terms" className="ml-2 block text-sm text-gray-300">
                  I agree to the <a href="#" className="text-neon-blue hover:text-blue-300">Terms of Service</a> and <a href="#" className="text-neon-blue hover:text-blue-300">Privacy Policy</a>
                </label>
              </div>
