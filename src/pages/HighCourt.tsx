...
import { Search, ArrowLeft, Database, Gavel, List, Shield } from "lucide-react";
...
type SearchType = 'cnr' | 'status' | 'orders' | 'cause' | 'caveat';
  ...
  const handleSearch = async () => {
    ...
    try {
      if (searchType === 'cnr' || searchType === 'status') {
        ...
        const result = await eCourtService.getHighCourtCaseStatus(cnrNumber);
      ...
      <div className="min-h-screen p-6">
        <div className="max-w-4xl mx-auto">
          <header className="flex items-center mb-8">
            ...
            <h1 className="text-2xl font-bold neon-text text-neon-purple">High Court</h1>
          </header>
              ...
              {showCaptcha && (
                ...
                >
                  ...
                  <div className="flex gap-4">
                    ...
                    <NeonButton onClick={submitCaptcha} disabled={loading} variant="purple">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                {caseDetails.nextHearingDate && (
                  <div>
                    ...
                    <p className="text-neon-purple">{caseDetails.nextHearingDate}</p>
                  </div>
                )}
